...
type Project struct {
	...
	Locality			int64							 `bson:"locality" json:"locality"`
...
func NewProject(name string, location int64, description string, url string, tryLink string, videoLink string, locality int64, challengeList []string) *Project {
	return &Project{
		Name:          name,
		Location:      location,
